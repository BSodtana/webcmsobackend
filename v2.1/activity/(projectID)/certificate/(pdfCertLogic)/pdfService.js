...
const generatePCPPdfTest = async (userFullName, projectName, projectNickname, activityDate, certDate, projectOwnerFullName, advisorName, advisorTitle) => {
    try {
        ...
        // date text
        const activityStringDate = formatThaiDate(new Date())
        const certStringDate = formatThaiDate(certDate)
