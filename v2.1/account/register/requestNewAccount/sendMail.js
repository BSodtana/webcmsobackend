  ...
  try {
    const sendmail = await axios.post(
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                        <tr>
                          <td class="content-block" style="font-family: Helvetica, sans-serif; vertical-align: top; color: #9a9ea6; font-size: 16px; text-align: center;" valign="top" align="center">
                            ...
                            <br> CMSO Online <a href="https://cmso.med.cmu.ac.th" style="text-decoration: underline; color: #9a9ea6; font-size: 16px; text-align: center;">Unsubscribe</a>.
                          </td>
                        </tr>
                        <tr>
      ...
      },
      {
        headers: {
          Authorization:
            'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2NjA2Mzc5MjcsImp0aSI6ImNtc28tNjJmYjUyZTc1ZmY5MyIsImlzcyI6InczLm1lZC5jbXUuYWMudGgiLCJuYmYiOjE2NjA2Mzc5MjcsImV4cCI6MTc1NTI0NTkyNywiZGF0YSI6eyJ1aWQiOiJjbXNvIiwiYXBwIjoibWFpbCIsImdyb3VwX2lkIjo5OX19.9tadXrpH7enA43emfUout33x4ugpsgEhnjNc3LLSUaw',
        },
      }
    )
    return sendmail.data.status
  } catch (error) {
    console.log(error)
...
module.exports = { SendEmailForCode }
